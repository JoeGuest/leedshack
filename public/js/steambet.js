...
module.exports=["$scope","SocketService","BetService","GameService","$interval",function(e,n,c,s,t){function o(){return{game:null,coins:null,bet:null,range:null,complete_time:null}}function i(){s.richest().success(function(n){e.richest=n})}function u(){c.coins().success(function(n){e.coins=n})}function l(){c.yourbets().success(function(n){e.yourbets=n})}function a(){c.allbets().success(function(n){e.allbets=n})}n.on("test",function(e){console.log(e)}),e.bet=o(),s.list().success(function(n){e.games=n}),i(),t(i,5e3),u(),t(u,5e3),l(),t(l,5e3),a(),t(a,5e3),e.submit=function(){c.create(e.bet).success(function(n){e.coins=n,e.message="bet placed!",e.bet=o(),l()})},e.coinChange=function(){e.coins-e.bet.coins<0&&(e.bet.coins=e.coins)},e.changeGame=function(){s.getStats(e.bet.game.id).success(function(n){e.num_players=n[0].num_players})}}];
...
module.exports=["$http",function(t){return{create:function(e){return t.post("/bet",e)},current:function(){return t.get("/bet/me")},friends:function(){return t.get("/bet/friends")},popular:function(){return t.get("/bet/popular")},coins:function(){return t.get("/coins")},yourbets:function(){return t.get("/yourbets")},allbets:function(){return t.get("/allbets")}}}];
