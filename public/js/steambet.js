...
module.exports=["$scope","SocketService","BetService","GameService",function(e,n,c,s){function t(){return{game:null,coins:null,bet:null,range:null,complete_time:null}}n.on("test",function(e){console.log(e)}),e.bet=t(),s.list().success(function(n){e.games=n}),s.richest().success(function(n){e.richest=n}),c.coins().success(function(n){e.coins=n}),e.submit=function(){c.create(e.bet).success(function(n){e.coins=n,e.message="bet placed!",e.bet=t()})},e.coinChange=function(){e.coins-e.bet.coins<0&&(e.bet.coins=e.coins)},e.changeGame=function(){s.getStats(e.bet.game.id).success(function(n){e.num_players=n[0].num_players})}}];
