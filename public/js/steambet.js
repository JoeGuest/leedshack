...
},{"./controllers":3,"./directives":4,"./services":8}],2:[function(require,module,exports){
module.exports=["$scope","SocketService","BetService","GameService",function(e,n,c,s){function t(){return{game:null,coins:null,bet:null,range:null,complete_time:null}}n.on("test",function(e){console.log(e)}),e.bet=t(),s.list().success(function(n){e.games=n}),s.richest().success(function(n){e.richest=n}),c.coins().success(function(n){e.coins=n}),e.submit=function(){c.create(e.bet).success(function(){e.message="BET SUBMITTED THANKS",e.bet=t()})},e.coinChange=function(){e.coins-e.bet.coins<0&&(e.bet.coins=e.coins)}}];
...
module.exports=["$http","SocketService",function(t,e){return{list:function(){return t.get("/games")},richest:function(){return t.get("/richest")}}}];
...
},{"./BetService":5,"./GameService":6,"./SocketService":7}]},{},[1]);
